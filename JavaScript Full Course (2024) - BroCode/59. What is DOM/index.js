/*
    DOM - DOCUMENT OBJECT MODEL
          ...
          representation. JavaScript can access the DOM to dynamically change the content, structure, and style of a web page.
*/
console.log(document);
console.dir(document);

document.body.style.background = "hsl(0, 0%, 80%)";
